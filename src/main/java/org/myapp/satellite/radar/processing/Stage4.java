...
public class Stage4 {
    ...
    public static void main(String[] args) {
        ...
        /*inputDir1="F:\\intellij-idea-workspace\\monitor-radar-core-v3\\processing\\subset"
        inputDir2="F:\\intellij-idea-workspace\\monitor-radar-core-v3\\processing\\topophaseremoval"
        outputDir="F:\\intellij-idea-workspace\\monitor-radar-core-v3\\processing\\stampsexport"
        graphsDir="F:\\intellij-idea-workspace\\monitor-radar-core-v3\\graphs"  snapDir="F:\intellij-idea-workspace\monitor-radar-core-v3\.snap"*/
        ...
        try {
            ...
            String[] sourceProductsDir = Files.find(Paths.get(inputDir1), 1, (path, attr) -> {
            ...
            Arrays.stream(sourceProductsDir).forEach(path -> {
