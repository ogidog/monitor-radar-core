...
public class Stage8 {
    public static void main(String[] args) {
        ...
        try {
            ...
            File file = new File(outputDir + File.separator + "prep" + File.separator + "pic"
                    + File.separator + "velocity" + File.separator + "velocity.kml");
            ...
            file = new File(outputDir + File.separator + "prep" + File.separator + "pic"
                    + File.separator + "velocity" + File.separator + "velocity_online.kml");
