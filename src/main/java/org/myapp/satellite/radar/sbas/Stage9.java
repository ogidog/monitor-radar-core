...
public class Stage9 {
    ...
    public static void process(String outputDir, String kmlObjectUrl, String taskId) throws Exception {

        String taskDir = outputDir + File.separator + taskId;

        File file = new File(taskDir + File.separator + "prep" + File.separator + "velocity.kml");
        BufferedReader br = new BufferedReader(new FileReader(file));
        String velocityKML = br.lines().map(line -> {
            if (line.contains("<href>velocity.png</href>")) {
                line = "<href>" + kmlObjectUrl + "/velocity.png</href>";
        ...
        file = new File(taskDir + File.separator + "prep" + File.separator + "velocity_online.kml");
        BufferedWriter bw = new BufferedWriter(new FileWriter(file));
        bw.write(velocityKML);
        bw.flush();
        bw.close();
